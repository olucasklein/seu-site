...
export default function Footer() {
  ...
  const footerLinks = {
    servicos: [
      ...
      { label: 'Planejamento', href: '#servicos' },
      { label: 'Desenvolvimento', href: '#servicos' },
      { label: 'Suporte', href: '#servicos' },
    ],
    empresa: [
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-semibold text-white">Seu Site</span>
            </Link>
            <p className="text-slate-400 mb-6 leading-relaxed">
              Empresa dedicada a entregar soluções de qualidade
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-slate-800 rounded-lg border border-slate-700 focus:border-slate-500 focus:ring-1 focus:ring-slate-500 outline-none text-white text-sm"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-white text-slate-900 rounded-lg hover:bg-slate-100 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
